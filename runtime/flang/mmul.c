...
typedef void (*mmul_funcptr_t)(void *, int, void *, int, int, void *, int, int);
                          ...
                          F90_Desc *as0, F90_Desc *bs0)
{
  ...
  switch (kind) {
  case __REAL4:
    dotp = (mmul_funcptr_t)dotp_real4;
    break;
  case __REAL8:
    dotp = (mmul_funcptr_t)dotp_real8;
    break;
  case __CPLX8:
    dotp = (mmul_funcptr_t)dotp_cplx8;
    break;
  case __CPLX16:
    dotp = (mmul_funcptr_t)dotp_cplx16;
    break;
  case __INT1:
    dotp = (mmul_funcptr_t)dotp_int1;
    break;
  case __INT2:
    dotp = (mmul_funcptr_t)dotp_int2;
    break;
  case __INT4:
    dotp = (mmul_funcptr_t)dotp_int4;
    break;
  case __LOG1:
    dotp = (mmul_funcptr_t)dotp_log1;
    break;
  case __LOG2:
    dotp = (mmul_funcptr_t)dotp_log2;
    break;
  case __LOG4:
    dotp = (mmul_funcptr_t)dotp_log4;
    break;
  case __INT8:
    dotp = (mmul_funcptr_t)dotp_int8;
    break;
  case __LOG8:
    dotp = (mmul_funcptr_t)dotp_log8;
    break;
  default:
                         ...
                         F90_Desc *as0, F90_Desc *bs0)
{
  ...
  switch (kind) {
  case __REAL4:
    mmul = (mmul_funcptr_t)dotp_real4;
    break;
  case __REAL8:
    mmul = (mmul_funcptr_t)dotp_real8;
    break;
  case __CPLX8:
    mmul = (mmul_funcptr_t)mmul_cplx8;
    break;
  case __CPLX16:
    mmul = (mmul_funcptr_t)mmul_cplx16;
    break;
  case __INT1:
    mmul = (mmul_funcptr_t)dotp_int1;
    break;
  case __INT2:
    mmul = (mmul_funcptr_t)dotp_int2;
    break;
  case __INT4:
    mmul = (mmul_funcptr_t)dotp_int4;
    break;
  case __LOG1:
    mmul = (mmul_funcptr_t)dotp_log1;
    break;
  case __LOG2:
    mmul = (mmul_funcptr_t)dotp_log2;
    break;
  case __LOG4:
    mmul = (mmul_funcptr_t)dotp_log4;
    break;
  case __INT8:
    mmul = (mmul_funcptr_t)dotp_int8;
    break;
  case __LOG8:
    mmul = (mmul_funcptr_t)dotp_log8;
    break;
  default:
