...
extern void ftn_mvmul_real8_(int *, __POINT_T *, __POINT_T *, double *,
                             double *, __POINT_T *, double *, double *,
                             double *);
extern void ftn_vmmul_real8_(int *, __POINT_T *, __POINT_T *, double *,
                             double *, __POINT_T *, double *, double *,
                             double *);
extern void ftn_mnaxnb_real8_(__POINT_T *, __POINT_T *, __POINT_T *, double *,
                              double *, __POINT_T *, double *, __POINT_T *,
                              double *, double *, __POINT_T *);
extern void ftn_mnaxtb_real8_(__POINT_T *, __POINT_T *, __POINT_T *, double *,
                              double *, __POINT_T *, double *, __POINT_T *,
                              double *, double *, __POINT_T *);
extern void ftn_mtaxnb_real8_(__POINT_T *, __POINT_T *, __POINT_T *, double *,
                              double *, __POINT_T *, double *, __POINT_T *,
                              double *, double *, __POINT_T *);
extern void ftn_mtaxtb_real8_(__POINT_T *, __POINT_T *, __POINT_T *, double *,
                              double *, __POINT_T *, double *, __POINT_T *,
                              double *, double *, __POINT_T *);
