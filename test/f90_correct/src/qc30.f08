...
program test
  ...
  integer(8), parameter :: rst1 = (-9223372036854775808.0_16, -9223372036854775808.0_16)
  ...
  integer(8), parameter :: rst5 = (9223372036854775807.0_16, 9223372036854775807.0_16)
  integer(8) :: rst6 = (-9223372036854775808.0_16, -9223372036854775808.0_16)
  ...
  integer(8) :: rst9 = (77.123456789012345678901234567890123456789_16,&
                                   77.123456789012345678901234567890123456789_16)
  integer(8) :: rst10 = (9223372036854775807.0_16, 9223372036854775807.0_16)

  expect(1) = -9223372036854775808
  expect(2) = -7
  expect(3) = 0
  expect(4) = 77
  expect(5) = 9223372036854775807
  expect(6) = -9223372036854775808
  expect(7) = -7
  expect(8) = 0
  expect(9) = 77
  expect(10) = 9223372036854775807
  expect(11) = -9223372036854775808
  expect(12) = -7
  expect(13) = 0
  expect(14) = 77
  expect(15) = 9223372036854775807
  expect(16) = -9223372036854775808
  expect(17) = -7
  expect(18) = 0
  expect(19) = 77
  expect(20) = 9223372036854775807

  c_16(1) = (-9223372036854775808.0_16, -9223372036854775808.0_16)
  ...
  c_16(4) = (77.123456789012345678901234567890123456789_16,&
             77.123456789012345678901234567890123456789_16)
  c_16(5) = (9223372036854775807.0_16, 9223372036854775807.0_16)
  ...
  result(n+4) = rst4
  result(n+5) = rst5
  result(n+6) = (-9223372036854775808.0_16, -9223372036854775808.0_16)
  ...
  result(n+9) = (77.123456789012345678901234567890123456789_16,&
             77.123456789012345678901234567890123456789_16)
  result(n+10) = (9223372036854775807.0_16, 9223372036854775807.0_16)
  result(n+11) = rst6
  result(n+12) = rst7
  result(n+13) = rst8
  result(n+14) = rst9
