...
program test
  ...
  expect(1) = (-9223372036854775808.0_16, 0.0_16)
  expect(2) = (-7.0_16, 0.0_16)
  expect(3) = (0.0_16, 0.0_16)
  expect(4) = (77.0_16, 0.0_16)
  expect(5) = (9223372036854775807.0_16, 0.0_16)
  expect(6) = (-9223372036854775808.0_16, 0.0_16)
  expect(7) = (-7.0_16, 0.0_16)
  expect(8) = (0.0_16, 0.0_16)
  expect(9) = (77.0_16, 0.0_16)
  expect(10) = (9223372036854775807.0_16, 0.0_16)
  expect(11) = (-9223372036854775808.0_16, 0.0_16)
  expect(12) = (-7.0_16, 0.0_16)
  expect(13) = (0.0_16, 0.0_16)
  expect(14) = (77.0_16, 0.0_16)
  expect(15) = (9223372036854775807.0_16, 0.0_16)
  expect(16) = (-9223372036854775808.0_16, 0.0_16)
  expect(17) = (-7.0_16, 0.0_16)
  expect(18) = (0.0_16, 0.0_16)
  expect(19) = (77.0_16, 0.0_16)
  expect(20) = (9223372036854775807.0_16, 0.0_16)
